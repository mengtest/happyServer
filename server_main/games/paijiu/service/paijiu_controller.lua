...
local REQUEST = {
	-- 下注
	[0x040000] = function(tcpAgent, pbObj, tcpAgentData) doProtocalAgent(tcpAgent, pbObj, tcpAgentData, 0x040000) end,
	-- 申请上庄
	[0x040001] = function(tcpAgent, pbObj, tcpAgentData) doProtocalAgent(tcpAgent, pbObj, tcpAgentData, 0x040001) end,
	-- 取消申请
	[0x040002] = function(tcpAgent, pbObj, tcpAgentData) doProtocalAgent(tcpAgent, pbObj, tcpAgentData, 0x040002) end,
}
