...
local REQUEST = {
	...
	[0x000503] = function(tcpAgent, pbObj, tcpAgentData)
		local re = skynet.call(addressResolver.getAddressByServiceName("LS_model_pay"), "lua", "queryVipFreeScore", tcpAgentData.userID)
		return 0x000504, re
	end,
	...
	[0x000505] = function(tcpAgent, pbObj, tcpAgentData) -- ÀñÈ¯»»½ð±Ò
	...
	[0x000506] = function(tcpAgent, pbObj, tcpAgentData)
